				...
				<div class="sparkline13-list" style="color:white !important">
					<div class="sparkline13-hd">
						<div class="main-sparkline13-hd">
							<h1  style="color:white !important">Statistiques du mois de <?php if(isset($active_mois)){echo af_date_date(date('Y-m-d'), -$active_mois);}else{echo af_date_date(date('Y-m-d'), 0);} ?></h1>
						</div>
					</div>
