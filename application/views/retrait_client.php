				...
				<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
					<div class="review-tab-pro-inner">
						<ul id="myTab3" class="tab-review-design">
							<li class="active"><a href="#description"><i class="icon nalika-edit" aria-hidden="true"></i> Retrait chez un client </a></li>
						</ul>
						<div id="myTabContent" class="tab-content custom-product-edit">
							<div class="product-tab-list tab-pane fade active in" id="description">
								...
								<?php echo form_open(base_url('/an2000/geststock/retrait_client')); ?>
									<div class="row">
											...
											<div class="review-content-section">
												...
												<div class="form-group data-custon-pick" id="data_1">
													<div class="input-group date">
														...
														<input type="date" id="datte" class="form-control" placeholder="Date retrait" name="datte" value="<?php echo set_value('datte'); ?>">
													</div>
												</div>
											</div>
										</div>
