					...
					<div class="review-tab-pro-inner">
						...
						<div id="myTabContent" class="tab-content custom-product-edit">
							<div class="product-tab-list tab-pane fade active in" id="description">
								...
								<?php echo form_open(base_url('/an2000/geststock/modifier_achat?ach='.$ach)); ?>
									<div class="row">
										<div class=" col-sm-offset-2 col-lg-8 col-md-8 col-sm-8 col-xs-12">
											<div class="review-content-section">
												...
												<div class="input-group mg-b-pro-edt">
													...
													<input type="text" id="bordereau" class="form-control" placeholder="Numéro bordereau" name="bordereau2" value="<?php echo set_value('bordereau2'); ?>">
												</div>
												...
												<div class="input-group mg-b-pro-edt">
													...
													<input style="color:#152036;font-weight:bold" disabled id="qnt" type="number" class="form-control" placeholder="Quantité ( Nombre de sac )" name="qnt" value="<?php echo set_value('qnt'); ?>">
													<input type="hidden" name="qnt" value="<?php echo set_value('qnt'); ?>">
												</div>
												...
												<div class="input-group mg-b-pro-edt">
													<span class="input-group-addon"><i class="fa fa-usd" aria-hidden="true"></i></span>
													<input style="color:#152036;font-weight:bold" disabled type="text" id="prix_t" class="form-control" placeholder="Prix total de l'achat" name="prix_t" value="<?php echo number_format(set_value('prix_t'),0,""," ").' FCFA'; ?>">
