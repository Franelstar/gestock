				...
				<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
					<div class="review-tab-pro-inner">
						<ul id="myTab3" class="tab-review-design">
							<li class="active"><a href="#description"><i class="icon nalika-edit" aria-hidden="true"></i> Modification d'un employé</a></li>
						</ul>
									...
									<div class="row">
										<div class=" col-sm-offset-2 col-lg-8 col-md-8 col-sm-8 col-xs-12">
											<div class="review-content-section">
												...
												<label class="control-label" for="tel">Téléphone de m'employé</label>
												<div class="input-group mg-b-pro-edt">
												...
												<div class="row">
													<div class="col-sm-5">
														<div class="inputGroup">
															<input value="1" id="radio1" name="desactiver" type="radio" <?php if($employe[0]['employe_status'] == 1){echo 'checked';} ?>/>
															<label for="radio1">Activer</label>
														</div>
													</div>
													<div class="col-sm-offset-2 col-sm-5">
														<div class="inputGroup">
															<input value="0" id="radio2" name="desactiver" type="radio" <?php if($employe[0]['employe_status'] == 0){echo 'checked';} ?>/>
