				...
				<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
					<div class="review-tab-pro-inner">
						<ul id="myTab3" class="tab-review-design">
							<li class="active"><a href="#description"><i class="icon nalika-edit" aria-hidden="true"></i> Retrait chez un fournisseur </a></li>
						</ul>
						<div id="myTabContent" class="tab-content custom-product-edit">
							<div class="product-tab-list tab-pane fade active in" id="description">
								...
								<?php echo form_open(base_url('/an2000/geststock/retrait_fournisseur')); ?>
									<div class="row">
										<div class=" col-sm-offset-3 col-lg-6 col-md-6 col-sm-6 col-xs-12">
											<div class="review-content-section">
												...
												<label class="control-label" for="versement"> Retrait (en FCFA) <span style="color:red"> * </span></label>
												<div class="input-group mg-b-pro-edt">
													<span class="input-group-addon"><i class="icon nalika-edit" aria-hidden="true"></i></span>
													<input min=0 id="versement" type="number" class="form-control" placeholder="Somme retirée" name="versement" value="<?php echo set_value('versement'); ?>">
												</div>
												...
												<label class="control-label" for="datte">Date de retrait</label>
												<div class="form-group data-custon-pick" id="data_1">
													<div class="input-group date">
														<span class="input-group-addon"><i class="fa fa-calendar"></i></span>
														<input type="date" id="datte" class="form-control" placeholder="Date de retrait" name="datte" value="<?php echo set_value('datte'); ?>">
													</div>
												</div>
											</div>
										</div>
